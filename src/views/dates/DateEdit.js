        ...
        <CCol xs="12" md="12">
          <CCard>
            ...
            <CCardFooter>
              ...
              {(user.data.userData.role[0] =="Admin" || user.data.userData.role[0] =="Sekreter")  && dateId!=0 && dateId!=null &&    <CButton type="submit" size="sm" color="success" onClick={() => {send(1);}}><CIcon name="cil-scrubber" /> Yeni Randevu</CButton> }
